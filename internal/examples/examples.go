...
var list = []Example{
	...
	{ID: "azure-basic", Description: "A gateway routing to a function that reads a database and publishes to a queue, on Azure"},
	{ID: "gcp-basic", Description: "A gateway, a function reading a database, and a queue worked by a function and a service, on Google Cloud"},
}
